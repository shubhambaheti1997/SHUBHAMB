...
<div class="container col-6"> <br> <br>
    <form action="pythonresult" method="post" name="question">
        ...
        @foreach($data as $data)
                ...
                <div class="card-body">
                    ...
                    <input type="radio" name="{{ $data->id }}" value="{{ $data->op3 }}">
                    {{ $data->op3 }} <br>



                    <input class="form_control" type="radio" name="{{ $data->id }}" value="{{ $data->op4 }}">
                    {{ $data->op4 }}
