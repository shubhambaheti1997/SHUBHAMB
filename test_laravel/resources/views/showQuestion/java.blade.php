            ...
            <table class="table table-bordered table-dark">
                ...
                @foreach($deb as $deb)
                    ...
                    <tr>
                        ...
                        <td>{{ $deb->ans }}</td>
                        <td><a class="btn btn-danger" href='deletejava/{{ $deb->question }}' role="button">Delete</a>
                        </td>
                        <td>
                            <form action="updatejava" method="get">

                                <input type="hidden" value="{{ $deb->question}}" name="question">
                                <input type="hidden" value="{{ $deb->op1}}" name="optiona">
                                <input type="hidden" value="{{ $deb->op2}}" name="option`b">
